            ...
            <div class="panel">
                <div class="panel-header">
                    ...
                    <div class="btn-box d-flex flex-wrap gap-2">
                        ...
                        <div class="btn-box">
                            <a href="dashboard-add-product.html" class="btn btn-sm btn-primary"><i
                        ...
                        <tbody>
                            <tr style="text-align: center">
                                ...
                                <td>
                                    <div class="table-product-card">
                                        <div class="part-img">
                                            <img src="{{ asset('administrator/dashboard/assets/images/product-img-1.jpg') }}"
                                                alt="Image">
                                        </div>
                                        <div class="part-txt">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="table-product-card">
                                        <div class="part-img">
                                            <img src="{{ asset('administrator/dashboard/assets/images/product-img-4.jpg') }}"
                                                alt="Image">
                                        </div>
                                        <div class="part-txt">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="table-product-card">
                                        <div class="part-img">
                                            <img src="{{ asset('administrator/dashboard/assets/images/product-img-3.jpg') }}"
                                                alt="Image">
                                        </div>
                                        <div class="part-txt">
