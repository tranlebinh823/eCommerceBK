                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <p class="perma-txt" hidden>
                                    Slug: <span data-link="https://example.com/" class="site-link text-primary"
                                        id="categoryPermalink">https://example.com/</span>
                                    <input type="text" class="form-control form-control-sm" hidden="" name="slug"
                                        id="editPermalink">
                    ...
                    <div class="panel-body">
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control form-control-sm" id="subcategoryTitle"
                                    name="sub_category_name">
                                <p class="perma-txt" hidden>
                                    Slug: <span data-link="https://example.com/" class="site-link text-primary"
                                        id="subcategoryPermalink">https://example.com/</span>
                                    <input type="text" class="form-control form-control-sm" hidden="" name="slug"
                                        id="editPermalink">
                                    <!-- Add the logic for the edit permalink buttons as needed -->
                                </p>
                            </div>
                            <select class="form-control form-control-sm" data-placeholder="Select" name="category_id">
                        ...
                        <tbody>
                            @foreach ($items as $i)
                                <tr>
                                    ...
                                    <td>{{ $i->slug }}</td>
                                    {{-- <td><a href="{{ route('admin.products', ['subcategory' => $subcategory->id]) }}">{{ $subcategory->products_count }}</a></td> --}}
                                    <td style="text-align: center;" >
                                            <a style="margin: 0 5px"
                                                href="{{ route('admin.categories.show',  $i->id) }}"><i
                                                    class="fa-light fa-eye"></i></a>
                                            <a  style="margin: 0 5px"
                                                href="{{ route('admin.categories.edit',  $i->id) }}"><i
                                                    class="fa-light fa-pen-to-square"></i></a>
                                            <a  style="margin: 0 5px"
                                                href="{{ route('admin.categories.destroy',  $i->id) }}"><i
