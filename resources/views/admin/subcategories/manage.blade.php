                            ...
                            @foreach ($items as $i)
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        <a style="margin: 0 5px" href="{{ route('admin.subcategories.show', $i->id) }}"><i
                                                class="fa-light fa-eye"></i></a>
                                        <a style="margin: 0 5px" href="{{ route('admin.subcategories.edit', $i->id) }}"><i
                                                class="fa-light fa-pen-to-square"></i></a>


                                                <a style="margin: 0 5px" href="{{ route('admin.subcategories.destroy', $i->id) }}"><i
