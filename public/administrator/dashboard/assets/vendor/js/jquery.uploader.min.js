    ...
    class h {
        ...
        createDefaultFiles(e) {
            ...
            this.options.defaultValue
                ...
                : e &&
                  (this.options.multiple ? e.split(",") : [e]).forEach(
                      (e, t) => {
                          let r = p(e);
        ...
        onFileUploadSuccess(e, i) {
            ...
            try {
                if (
                    ((t = this.options.ajaxConfig.responseConverter(e, i)),
                    !t.url)
                )
                    return (
                ...
                return (
                    ...
                    void this.onFileUploadError(e, "Error")
                );
            }
            e.url && e.url.startsWith("blob") && d.revokeBlobUrl(e.url),
                ...
                (e.status = h.fileStatus.uploaded),
                e.$ele
                    .find(".jquery-uploader-preview-main > img")
                    .attr("src", e.url),
                this.refreshPreviewFileList(),
                this.refreshValue();
        }
